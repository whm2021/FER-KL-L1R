function [x, x_it, primal_obj_value, theta, stop_crit_it, iter, time_it, time_it_screen, num_screen] = CoD_KL_l1_Sta_GAP(A, y, lambda, lambda0, x0, theta0, para, precalc)
% 两阶段筛选准则
% Author: Hongmei Wang
% Date: 17 Oct 2021
[n, m] = size(A);
